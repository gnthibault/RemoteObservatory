...
class PPBA(IndiDevice, IndiFocuserMixin):
    """
        Return of indi_getprop -h 192.168.8.202 -p 7624 "Pegasus PPBA.*.*"
        Pegasus PPBA.CONNECTION.CONNECT=On
            Pegasus PPBA.CONNECTION.DISCONNECT=Off
            Pegasus PPBA.DRIVER_INFO.DRIVER_NAME=Pegasus PPBA
            Pegasus PPBA.DRIVER_INFO.DRIVER_EXEC=indi_pegasus_ppba
            Pegasus PPBA.DRIVER_INFO.DRIVER_VERSION=1.3
            Pegasus PPBA.DRIVER_INFO.DRIVER_INTERFACE=32904
            Pegasus PPBA.DEBUG.ENABLE=Off
            Pegasus PPBA.DEBUG.DISABLE=On
            Pegasus PPBA.SIMULATION.ENABLE=Off
            Pegasus PPBA.SIMULATION.DISABLE=On
            Pegasus PPBA.CONFIG_PROCESS.CONFIG_LOAD=Off
            Pegasus PPBA.CONFIG_PROCESS.CONFIG_SAVE=Off
            Pegasus PPBA.CONFIG_PROCESS.CONFIG_DEFAULT=Off
            Pegasus PPBA.CONFIG_PROCESS.CONFIG_PURGE=Off
            Pegasus PPBA.POLLING_PERIOD.PERIOD_MS=1000
            Pegasus PPBA.CONNECTION_MODE.CONNECTION_SERIAL=On
            Pegasus PPBA.SYSTEM_PORTS.Pegasus_Astro_UPBv2_revD_UPB25S4VWV=Off
            Pegasus PPBA.SYSTEM_PORTS.Pegasus_Astro_PPBADV_Gen2C_PPBA93RF0I=Off
            Pegasus PPBA.SYSTEM_PORTS.Arduino_Uranus_MeteoSensor_95A5389D50555233342E3120FF12122B=Off
            Pegasus PPBA.SYSTEM_PORTS.1a86_USB_Serial=Off
            Pegasus PPBA.DEVICE_PORT.PORT=/dev/serial/by-id/usb-Pegasus_Astro_PPBADV_Gen2C_PPBA93RF0I-if00-port0
            Pegasus PPBA.DEVICE_BAUD_RATE.9600=On
            Pegasus PPBA.DEVICE_BAUD_RATE.19200=Off
            Pegasus PPBA.DEVICE_BAUD_RATE.38400=Off
            Pegasus PPBA.DEVICE_BAUD_RATE.57600=Off
            Pegasus PPBA.DEVICE_BAUD_RATE.115200=Off
            Pegasus PPBA.DEVICE_BAUD_RATE.230400=Off
            Pegasus PPBA.DEVICE_AUTO_SEARCH.INDI_ENABLED=Off
            Pegasus PPBA.DEVICE_AUTO_SEARCH.INDI_DISABLED=On
            Pegasus PPBA.DEVICE_PORT_SCAN.Scan Ports=Off
            Pegasus PPBA.QUADOUT_POWER.QUADOUT_ON=On
            Pegasus PPBA.QUADOUT_POWER.QUADOUT_OFF=Off
            Pegasus PPBA.ADJOUT_VOLTAGE.ADJOUT_OFF=On
            Pegasus PPBA.ADJOUT_VOLTAGE.ADJOUT_3V=Off
            Pegasus PPBA.ADJOUT_VOLTAGE.ADJOUT_5V=Off
            Pegasus PPBA.ADJOUT_VOLTAGE.ADJOUT_8V=Off
            Pegasus PPBA.ADJOUT_VOLTAGE.ADJOUT_9V=Off
            Pegasus PPBA.ADJOUT_VOLTAGE.ADJOUT_12V=Off
            Pegasus PPBA.POWER_SENSORS.SENSOR_VOLTAGE=13.699999999999999289
            Pegasus PPBA.POWER_SENSORS.SENSOR_CURRENT=0.015384615384615385469
            Pegasus PPBA.POWER_SENSORS.SENSOR_AVG_AMPS=0.02999999999999999889
            Pegasus PPBA.POWER_SENSORS.SENSOR_AMP_HOURS=0.040000000000000000833
            Pegasus PPBA.POWER_SENSORS.SENSOR_WATT_HOURS=0.56999999999999995115
            Pegasus PPBA.POWER_SENSORS.SENSOR_TOTAL_CURRENT=0
            Pegasus PPBA.POWER_SENSORS.SENSOR_12V_CURRENT=0.2000000000000000111
            Pegasus PPBA.POWER_SENSORS.SENSOR_DEWA_CURRENT=0
            Pegasus PPBA.POWER_SENSORS.SENSOR_DEWB_CURRENT=0
            Pegasus PPBA.POWER_ON_BOOT.POWER_PORT_1=On
            Pegasus PPBA.POWER_ON_BOOT.POWER_PORT_2=On
            Pegasus PPBA.POWER_ON_BOOT.POWER_PORT_3=On
            Pegasus PPBA.POWER_ON_BOOT.POWER_PORT_4=On
            Pegasus PPBA.REBOOT_DEVICE.REBOOT=Off
            Pegasus PPBA.POWER_WARM.POWER_WARN_ON=Ok
            Pegasus PPBA.LED_INDICATOR.LED_ON=On
            Pegasus PPBA.LED_INDICATOR.LED_OFF=Off
            Pegasus PPBA.AUTO_DEW.INDI_ENABLED=Off
            Pegasus PPBA.AUTO_DEW.INDI_DISABLED=On
            Pegasus PPBA.AUTO_DEW_SETTINGS.AGGRESSION=0
            Pegasus PPBA.DEW_PWM.DEW_A=82.352941176470579876
            Pegasus PPBA.DEW_PWM.DEW_B=82.352941176470579876
            Pegasus PPBA.FOCUS_MOTION.FOCUS_INWARD=On
            Pegasus PPBA.FOCUS_MOTION.FOCUS_OUTWARD=Off
            Pegasus PPBA.REL_FOCUS_POSITION.FOCUS_RELATIVE_POSITION=0
            Pegasus PPBA.ABS_FOCUS_POSITION.FOCUS_ABSOLUTE_POSITION=0
            Pegasus PPBA.FOCUS_MAX.FOCUS_MAX_VALUE=100000
            Pegasus PPBA.FOCUS_ABORT_MOTION.ABORT=Off
            Pegasus PPBA.FOCUS_SYNC.FOCUS_SYNC_VALUE=0
            Pegasus PPBA.FOCUS_REVERSE_MOTION.INDI_ENABLED=Off
            Pegasus PPBA.FOCUS_REVERSE_MOTION.INDI_DISABLED=On
            Pegasus PPBA.FOCUS_BACKLASH_TOGGLE.INDI_ENABLED=Off
            Pegasus PPBA.FOCUS_BACKLASH_TOGGLE.INDI_DISABLED=On
            Pegasus PPBA.FOCUS_BACKLASH_STEPS.FOCUS_BACKLASH_VALUE=0
            Pegasus PPBA.FOCUSER_SETTINGS.SETTING_MAX_SPEED=400
            Pegasus PPBA.FOCUSER_DRIVE.STEP_FULL=Off
            Pegasus PPBA.FOCUSER_DRIVE.STEP_HALF=On
            Pegasus PPBA.FOCUSER_DRIVE.STEP_FORTH=Off
            Pegasus PPBA.FOCUSER_DRIVE.STEP_EIGHTH=Off
            Pegasus PPBA.WEATHER_UPDATE.PERIOD=60
            Pegasus PPBA.WEATHER_REFRESH.REFRESH=Off
            Pegasus PPBA.WEATHER_OVERRIDE.OVERRIDE=Off
            Pegasus PPBA.WEATHER_STATUS.WEATHER_TEMPERATURE=Ok
            Pegasus PPBA.WEATHER_PARAMETERS.WEATHER_TEMPERATURE=0
            Pegasus PPBA.WEATHER_PARAMETERS.WEATHER_HUMIDITY=0
            Pegasus PPBA.WEATHER_PARAMETERS.WEATHER_DEWPOINT=0
            Pegasus PPBA.WEATHER_TEMPERATURE.MIN_OK=-15
            Pegasus PPBA.WEATHER_TEMPERATURE.MAX_OK=35
            Pegasus PPBA.WEATHER_TEMPERATURE.PERC_WARN=15
            Pegasus PPBA.WEATHER_TEMPERATURE.ALERT_TYPE=0
            Pegasus PPBA.WEATHER_HUMIDITY.MIN_OK=0
            Pegasus PPBA.WEATHER_HUMIDITY.MAX_OK=100
            Pegasus PPBA.WEATHER_HUMIDITY.PERC_WARN=15
            Pegasus PPBA.WEATHER_HUMIDITY.ALERT_TYPE=0
            Pegasus PPBA.WEATHER_DEWPOINT.MIN_OK=0
            Pegasus PPBA.WEATHER_DEWPOINT.MAX_OK=100
            Pegasus PPBA.WEATHER_DEWPOINT.PERC_WARN=15
            Pegasus PPBA.WEATHER_DEWPOINT.ALERT_TYPE=0
            Pegasus PPBA.FIRMWARE_INFO.VERSION=2.12.3
            Pegasus PPBA.FIRMWARE_INFO.UPTIME=1.207
    """
    def __init__(self,
                 config=None,
