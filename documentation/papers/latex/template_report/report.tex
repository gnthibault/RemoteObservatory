...
We can also cite content with \cite{astroplan_1}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.65\textwidth]{../../figures/Solid_Angle_1_Steradian.png}
...
The accepted value (periodic table) is \SI{24.3}{\gram\per\mole} \cite{astroplan_1}. The percentage discrepancy between the accepted value and the result obtained here is 1.3\%. Because only a single measurement was made, it is not possible to calculate an estimated standard deviation.
