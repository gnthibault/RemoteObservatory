...
indiserver indi_simulator_ccd indi_simulator_guide indi_simulator_telescope indi_simulator_focus indi_simulator_wheel indi_simulator_weather indi_simulator_dome
#cd -
