...
###############################################################################
    ...
    #     #mqtt_host = self.config["messaging_publisher"]['mqtt_host']
    #     #mqtt_port = self.config["messaging_publisher"]['mqtt_port']
    ...
    #     self._msg_client = PanMessaging(**self.config["messaging_publisher"])
    # 
